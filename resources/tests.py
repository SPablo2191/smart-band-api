...
class TestsAPI(MethodResource, Resource):
    @doc(
        description="Petición GET para recuperar las evaluaciones registradas de un profesor",
        tags=["Test"],
    )
    ...
    def get(self, teacher_id):
        tests = (
            Test.query.filter(Test.status == True, Test.teacher_id == teacher_id)
            .order_by(Test.id)
            .all()
        )
        return Response(
...
class TestAPI(MethodResource, Resource):
    @doc(
        description="Petición GET para recuperar una evaluación por el id del profesor y de la promoción",
        tags=["Test"],
    )
    @marshal_with(test_schema)
    ...
    @doc(
        description="Petición PUT para actualizar una evaluación por el id del profesor y de la promoción",
        tags=["Test"],
    )
    ...
    @doc(
        description="Petición DELETE para eliminar una evaluación por el id del profesor y de la promoción",
        tags=["Test"],
    )
    @marshal_with(test_schema)
